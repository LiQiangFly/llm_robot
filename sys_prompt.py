...
我的指令：先打开夹抓，再把关节2旋转到30度。你输出：{'function':['open_gripper()', single_joint_move(2, 30)], 'response':'你之前做的指星笔，就是通过关节2调俯仰角'}
...
我的指令：关闭夹抓，打开摄像头。你输出：{'function':[close_gripper(), check_camera()], 'response':'你是我的眼，带我阅读浩瀚的书海'}
